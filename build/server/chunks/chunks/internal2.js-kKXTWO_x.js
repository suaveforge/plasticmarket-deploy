import { j as render, k as set, L as LEGACY_PROPS, m as get, o as flushSync, p as define_property, q as mutable_source, t as init_operations, u as get_first_child, v as get_next_sibling, H as HYDRATION_ERROR, w as set_hydrating, x as set_hydrate_node, y as hydration_failed, z as clear_text_content, A as component_root, B as hydrate_node, C as create_text, D as boundary, E as array_from, F as is_passive_event, G as set_active_reaction, I as set_active_effect, J as active_reaction, K as active_effect, s as setContext, M as derived, N as hydrating, O as push$1, P as component_context, Q as hydration_mismatch, R as pop$1 } from './server.js-CPD9auUj.js';
...
var options = {
	...
	templates: {
		app: ({ head, body, assets, nonce, env }) => "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\"/><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"/><meta name=\"theme-color\" content=\"#ffffff\"/><script async src=\"https://sitehub.suaveforge.com/analytics-loader.js\" data-sitehub-project=\"p40\"><\/script><script id=\"sitehub-searchops-p40-jsonld\" type=\"application/ld+json\">{\"@context\":\"https://schema.org\",\"@type\":\"WebApplication\",\"name\":\"PlasticMarket\",\"url\":\"https://plasticmarket.suaveforge.com/\",\"description\":\"피규어·프라모델을 탐색하고 판매·컬렉션·주문을 관리하는 글로벌 마켓플레이스입니다.\",\"applicationCategory\":\"ShoppingApplication\",\"creator\":{\"@type\":\"Organization\",\"name\":\"SuaveForge\",\"url\":\"https://suaveforge.com/\"},\"isPartOf\":{\"@type\":\"WebSite\",\"name\":\"SuaveForge\",\"url\":\"https://suaveforge.com/\"}}<\/script>" + head + "</head><body data-sveltekit-preload-data=\"hover\"><div style=\"display:contents\">" + body + "</div></body></html>\n",
		error: error_template_default
	},
	version_hash: "16p2uwn"
};
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('../entries/hooks.server.js-CcKvXD37.js'));
	let reroute;
	let transport;
	return {
		handle,
...
//# sourceMappingURL=internal2.js-kKXTWO_x.js.map
